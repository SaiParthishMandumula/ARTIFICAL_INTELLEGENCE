...
from MinMaxImplementation import *

def play(currentGame, depth):
    tree = MinMaxImplementation(currentGame, depth)
    move = tree.GetNextPossibleMove()
...
def oneMoveGame(currentGame, depth):
    ...
    currentGame.currentTurn = 2 - currentGame.currentTurn
